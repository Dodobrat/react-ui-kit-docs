							...
							<Flex spacingY='xs'>
								...
								<Flex.Col col={{ xs: "12" }}>
									<FormControl label='E-mail' htmlFor='reg-email'>
										<Input name='email' id='reg-email' type='email' placeholder='Enter E-mail' />
									</FormControl>
								</Flex.Col>
								<Flex.Col col={{ xs: "6" }}>
								...
								<Flex.Col col={{ xs: "12" }}>
									<FormControl label='Upload Avatar' htmlFor='avatar'>
										<Input name='avatar' type='file' placeholder='Add Picture' />
									</FormControl>
								</Flex.Col>
								<Flex.Col col={{ xs: "12" }}>
			...
			<Card>
				...
				<Card.Body>
					<Form id='all-types-form' onFormSubmit={({ values }) => console.log(values)}>
						...
						<br />
						<Radio name='gender' id='male' value='male' seamless className='mb--1'>
							Male
						</Radio>
						<Radio name='gender' id='female' value='female' seamless className='mb--1'>
							Female
						</Radio>
